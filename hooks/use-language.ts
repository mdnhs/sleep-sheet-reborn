...
export const translations = {
  en: {
    ...
    whatsappOrderMessage: "Hello! I want to order this product:",
    yourCart: "Your Cart",
    subtotal: "Subtotal",
    total: "Total",
    ...
    errorInvalidPhone: "Please enter a valid 11-digit mobile number (e.g. 017xxxxxxxx)",
  ...
  bn: {
    ...
    whatsappOrderMessage: "আসসালামু আলাইকুম! আমি এই পণ্যটি অর্ডার করতে চাই:",
    ...
    expiryLabel: "মেয়াদ",
    cvvLabel: "সিভিভি (CVV)",
    fullNamePlaceholder: "আপনার পুরো নাম (যেমন: তানভীর আহমেদ)",
    ...
    errorInvalidPhone: "সঠিক ১১ ডিজিটের মোবাইল নম্বর দিন (যেমন: 017xxxxxxxx)",
