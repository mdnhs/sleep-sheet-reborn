  ...
  return (
    <main
      ...
      className={cn(
        ...
        // this item (sitting beside the sidebar in the top-level flex row)
        // won't shrink for wide descendants (e.g. a many-column table),
        // so the whole page overflows horizontally instead of the content
        // scrolling within its own inner container.
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn("flex h-8 items-center gap-2 rounded-md px-2 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:justify-center", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
